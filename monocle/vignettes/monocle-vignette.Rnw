...
plot_genes_jitter(cds_subset, nrow=1, ncol=NULL, plot_trend=TRUE)
@ %def
...
diff_test_res[,c("gene_short_name", "pval", "qval")]
plot_genes_jitter(cds_subset, grouping="Time", color_by="State", plot_trend=TRUE) + facet_wrap( ~ gene_label, scales="free_y")
@ %def 
