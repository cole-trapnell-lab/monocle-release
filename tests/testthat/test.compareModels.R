...
#test_that("compareModels() reports the expected data frame when evaluating the full model and reduced model of cds subset, also validates fitModels()")
...
expect_equal(diff_test_res$status, "OK")
expect_equal(diff_test_res$family, "negbinomial.size")
expect_equal(diff_test_res$pval, c(9.946038e-118, 2.407649e-01, 8.368752e-17))
expect_equal(diff_test_res$qval, c(2.983812e-11, 2.407649e-01, 1.255313e-16))
