...
\subsection{Dimensionality reduction via graph structure learning}{
...
\subsection{Dimensionality reduction via learning a tree}{
...
\subsection{Discriminative dimensionality reduction via learning a tree}{
...
\subsection{The actual algorithm of DDRTree}{
...
\subsection{Arguments and return values in DDRTree}{
