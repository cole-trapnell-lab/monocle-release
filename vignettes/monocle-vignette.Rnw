...
HSMM <- detectGenes(HSMM, min_expr = 0.1)
 ...
 HSMM <- reduceDimension(HSMM, reduction_method="tSNE", residualModelFormulaStr="~Media + num_genes_expressed")
 ...
 HSMM <- clusterCells(HSMM,
                      ...
                      residualModelFormulaStr="~Media + num_genes_expressed")
 #plot_cell_clusters(HSMM, color_by = 'as.factor(CellType)', show_density = F)
