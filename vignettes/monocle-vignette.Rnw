...
<<semi_sup_ordering_trajectory, include=TRUE, eval=TRUE, fig.width = 4, fig.height = 3.5, warning=FALSE, fig.align="center">>=
...
about tools for dealing with branched trajectories in section \cite{subsec:BEAM_trajectory}.
