...
\hlstd{baseLoc} \hlkwb{<-} \hlstr{'./inst'}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in readChar(con, 5L, useBytes = TRUE): cannot open compressed file './inst/extdata/lung\_phenotype\_data.RData', probable reason 'No such file or directory'}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in readChar(con, 5L, useBytes = TRUE): cannot open compressed file './inst/extdata/lung\_exprs\_data.RData', probable reason 'No such file or directory'}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in readChar(con, 5L, useBytes = TRUE): cannot open compressed file './inst/extdata/lung\_feature\_data.RData', probable reason 'No such file or directory'}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'lung\_exprs\_data' not found}}\begin{alltt}
\hlstd{pd} \hlkwb{<-} \hlkwd{new}\hlstd{(}\hlstr{"AnnotatedDataFrame"}\hlstd{,} \hlkwc{data} \hlstd{= lung_phenotype_data)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in value[[3L]](cond): object 'lung\_phenotype\_data' not found\\\#\#\ \  AnnotatedDataFrame 'initialize' could not update varMetadata:\\\#\#\ \  perhaps pData and varMetadata are inconsistent?}}\begin{alltt}
\hlstd{fd} \hlkwb{<-} \hlkwd{new}\hlstd{(}\hlstr{"AnnotatedDataFrame"}\hlstd{,} \hlkwc{data} \hlstd{= lung_feature_data)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in value[[3L]](cond): object 'lung\_feature\_data' not found\\\#\#\ \  AnnotatedDataFrame 'initialize' could not update varMetadata:\\\#\#\ \  perhaps pData and varMetadata are inconsistent?}}\begin{alltt}
\hlcom{# Now, make a new CellDataSet using the RNA counts}
\hlstd{lung} \hlkwb{<-} \hlkwd{newCellDataSet}\hlstd{(}\hlkwd{as.matrix}\hlstd{(lung_exprs_data),}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.matrix(lung\_exprs\_data): object 'lung\_exprs\_data' not found}}\begin{alltt}
\hlstd{lung} \hlkwb{<-} \hlkwd{estimateSizeFactors}\hlstd{(lung)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in estimateSizeFactors(lung): error in evaluating the argument 'object' in selecting a method for function 'estimateSizeFactors': Error: object 'lung' not found}}\begin{alltt}
\hlstd{lung} \hlkwb{<-} \hlkwd{estimateDispersions}\hlstd{(lung)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in estimateDispersions(lung): error in evaluating the argument 'object' in selecting a method for function 'estimateDispersions': Error: object 'lung' not found}}\begin{alltt}
\hlkwd{pData}\hlstd{(lung)}\hlopt{$}\hlstd{Total_mRNAs} \hlkwb{<-} \hlkwd{colSums}\hlstd{(}\hlkwd{exprs}\hlstd{(lung))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in exprs(lung): error in evaluating the argument 'object' in selecting a method for function 'exprs': Error: object 'lung' not found}}\begin{alltt}
\hlstd{lung} \hlkwb{<-} \hlkwd{detectGenes}\hlstd{(lung,} \hlkwc{min_expr} \hlstd{=} \hlnum{1}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in exprs(cds): error in evaluating the argument 'object' in selecting a method for function 'exprs': Error: object 'lung' not found}}\begin{alltt}
\hlstd{expressed_genes} \hlkwb{<-} \hlkwd{row.names}\hlstd{(}\hlkwd{subset}\hlstd{(}\hlkwd{fData}\hlstd{(lung), num_cells_expressed} \hlopt{>=} \hlnum{120}\hlstd{))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in fData(lung): error in evaluating the argument 'object' in selecting a method for function 'fData': Error: object 'lung' not found}}\begin{alltt}
\hlstd{ordering_genes} \hlkwb{<-} \hlstd{expressed_genes}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'expressed\_genes' not found}}\begin{alltt}
\hlstd{lung} \hlkwb{<-} \hlkwd{setOrderingFilter}\hlstd{(lung, ordering_genes)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in fData(cds): error in evaluating the argument 'object' in selecting a method for function 'fData': Error: object 'lung' not found}}\begin{alltt}
\hlstd{lung} \hlkwb{<-} \hlkwd{reduceDimension}\hlstd{(lung,} \hlkwc{use_vst} \hlstd{= F,} \hlkwc{pseudo_expr} \hlstd{=} \hlnum{1}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in exprs(cds): error in evaluating the argument 'object' in selecting a method for function 'exprs': Error: object 'lung' not found}}\begin{alltt}
\hlstd{lung} \hlkwb{<-} \hlkwd{orderCells}\hlstd{(lung,} \hlkwc{num_paths}\hlstd{=}\hlnum{2}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in t(cds@reducedDimS): object 'lung' not found}}\begin{alltt}
\hlkwd{plot_spanning_tree}\hlstd{(lung,} \hlkwc{color_by}\hlstd{=}\hlstr{"Time"}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in pData(cds): error in evaluating the argument 'object' in selecting a method for function 'pData': Error: object 'lung' not found}}\begin{alltt}
\hlstd{BEAM_res} \hlkwb{<-} \hlkwd{BEAM}\hlstd{(lung)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}BEAM"{}}}\begin{alltt}
\hlkwd{head}\hlstd{(BEAM_res)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in head(BEAM\_res): object 'BEAM\_res' not found}}\end{kframe}
\end{knitrout}
