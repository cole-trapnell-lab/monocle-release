...
project_to_representatives <- function(data, 
                                       ...
                                       louvain_res, 
                                       pd, 
                                       method = c('drl', 'fr', 'kk', 'SSE', 'PSL'), #(fr, kk) SSE or other methods? 
                                       start.temp = NULL, 
                                       verbose, 
                                       ...) {
  extra_arguments <- list(...)
